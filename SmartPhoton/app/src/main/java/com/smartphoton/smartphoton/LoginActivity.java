package com.smartphoton.smartphoton;
...
//                        task.execute();
                ...
                // DO!:
                Async.executeAsync(ParticleCloud.get(view.getContext()), new Async.ApiWork<ParticleCloud, Object>() {
                    ...
                    public Object callApi(@NonNull ParticleCloud sparkCloud) throws ParticleCloudException, IOException {
                        ...
                        mDevice = sparkCloud.getDevice("43002A000247353138383138");
                        Object obj;
